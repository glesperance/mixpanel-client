...
MixpanelClient.prototype._saveSuperProperties = function() {
  this.cookieJar && this.cookieJar.set(this.MIXPANEL_COOKIE_NAME, this.superProperties);
}
...
function MixpanelClient() {
  ...
  this.MIXPANEL_COOKIE_NAME = 'mp' + this.APIToken + '_mixpanel';

  this.cookieJar            = this.req && this.res && new cookies(req, res);

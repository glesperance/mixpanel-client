...
function MixpanelClient() {
  ...
  this.cookieJar            = this.req && this.res ? new cookies(req, res) : undefined;

  this.superProperties      = this.cookieJar && this.cookieJar.get(this.MIXPANEL_COOKIE_NAME) ? JSON.parse(decodeURIComponent(this.cookieJar.get(this.MIXPANEL_COOKIE_NAME))) : {};
